...
He has a strong record of leading and stewarding open-source funding—with grants from the Moore Foundation, CZI, NSF, and the Sloan Foundation supporting NumPy, SciPy, NetworkX, and the wider ecosystem. He previously served as a director of NumFOCUS and co-chair of the PSF Scientific Python Grants working group.

He is an experienced community organizer: co-founder of the ImageXD image-analysis workshops, an organizer of the Scientific Python developer summits, a long-time SciPy conference organizer, and a member of the team developing the mystmd documentation engine.
